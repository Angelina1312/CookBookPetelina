...
struct Recipes {
    ...
    static func getRecipe()->[Recipes] {
        return [
            ...
            Recipes(recipeName: "Мол. коктейль", recipeAuthor: "В.Лось", recipeRating: 4.5, recipeText: "Банан 2, Молоко или кокосовое молоко 350 мл., Какао 2 ст. ложки, Мед 1 ст. ложка, Кокосовая стружка для присыпки", recipeIcon: "ic_milkshake", recipeImage: "im_milkshake"),
